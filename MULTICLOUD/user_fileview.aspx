<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_fileview.aspx.cs" Inherits="index" %>
                ...
                <tr>
                    <td colspan="2">
                        <asp:TextBox ID="TextBox7" runat="server" Height="80px" TextMode="MultiLine" 
                            Width="458px" Visible="False"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label4" runat="server" Text="Enter Secret Key" Visible="False"></asp:Label>
                        &nbsp;
                        <asp:TextBox ID="TextBox9" runat="server" Visible="False" Width="201px"></asp:TextBox>
                        ...
                        <asp:TextBox ID="TextBox8" runat="server" Height="80px" TextMode="MultiLine" 
                            Width="456px" Visible="False"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </asp:Panel>
