<%@ Page Language="C#" AutoEventWireup="true" CodeFile="owner.aspx.cs" Inherits="index" %>
            ...
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" 
                        NavigateUrl="registration.aspx" BackColor="#CCFFFF" ForeColor="#3366FF">New User</asp:HyperLink>
                </td>
            </tr>
        </table>
      </div>
