<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cloud3.aspx.cs" Inherits="index" %>
  ...
  <div id="content">
    ...
    <div class="line">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="cloud3data.aspx?did={0}" HeaderText="More Action" 
                    Text="Approve / Deny" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [uid], [title], [s3appr], [id] FROM [cloud_data] WHERE ([s3appr] = @s3appr)">
            <SelectParameters>
                <asp:Parameter DefaultValue="No" Name="s3appr" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
      </div>
    <div class="one-half">
