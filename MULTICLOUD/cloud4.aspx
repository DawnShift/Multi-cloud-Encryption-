<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cloud4.aspx.cs" Inherits="index" %>
...
<div id="wrapper">
  <div id="sidebar">
    ...
    <div id="menu" class="menu-v">
      <ul>
        <li><a href="cloud3.aspx" class="active">Home</a></li>        
  ...
  <div id="content">
    ...
    <div class="line">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="cloud4data.aspx?did={0}" HeaderText="More Action" 
                    Text="Approve / Deny" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [uid], [title], [s3appr], [id] FROM [cloud_data] WHERE ([s4appr] = @s4appr)">
            <SelectParameters>
                <asp:Parameter DefaultValue="No" Name="s4appr" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
      </div>
    <div class="one-half">
