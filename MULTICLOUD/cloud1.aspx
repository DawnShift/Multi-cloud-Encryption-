<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cloud1.aspx.cs" Inherits="index" %>
  ...
  <div id="content">
    ...
    <div class="line">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="cloud1data.aspx?did={0}" HeaderText="More Action" 
                    Text="Approve / Deny" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [uid], [title], [s1appr], [id] FROM [cloud_data] WHERE ([s1appr] = @s1appr)">
            <SelectParameters>
                <asp:Parameter DefaultValue="No" Name="s1appr" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
      </div>
    <div class="one-half">
